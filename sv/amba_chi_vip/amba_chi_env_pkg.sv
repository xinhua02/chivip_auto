package amba_chi_env_pkg;
  ...
  `include "amba_chi_master_snoop_burst_seq.sv"
  `include "amba_chi_slave_snoop_burst_seq.sv"
  `include "amba_chi_master_snoop_orphan_seq.sv"
  `include "amba_chi_slave_snoop_orphan_seq.sv"
  ...
  `include "amba_chi_snoop_burst_vseq.sv"
